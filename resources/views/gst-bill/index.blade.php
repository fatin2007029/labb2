...
@if ($errors->any())
<div class="alert alert-danger">
    <strong>Validation errors:</strong> Please fix the following issues<br>
    <ul>
        @foreach ($errors->all() as $error)
        <li>{{ $error }}</li>
        @endforeach
...
@endif
            ...
            @else
                ...
                <span>No party information.</span>
                <span>Cz this party has been deleted</span>
            @endif
                            </td>
                                    ...
                                    <td>
                                        <div class="btn-group dropdown">
                                            ...
                                            <a class="dropdown-item" href="{{ route('delete', ['table' => 'gst_bills','id' =>  $bill->id]) }}"><i class="mdi mdi-delete mr-2 text-muted font-18 vertical-middle"></i>Delete</a>  
