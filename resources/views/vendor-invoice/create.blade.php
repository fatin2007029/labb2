...
@endif
                                    ...
                                    <form class="needs-validation pb-2" method="post" action="{{ route('vendor-invoice.store') }}">
                                        ...
                                        <!-- Add hidden input for created_at -->
         ...
         <!-- Add JavaScript to set the value of created_at field -->
         <script>
    ...
    <script>
        function validateTotalAmount() {
            ...
            if (!totalAmount.trim()) {
                // Show a reminder message using a session
                alert('Please enter the total amount before submitting.');
