...
class VendorInvoice extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->filled('total_amount')) {
            // If total_amount is not set, redirect back with an error message
            return redirect()->back()->withInput()->withErrors(['total_amount' => 'Please enter the total amount.']);
        }
    ...
    public function show($id)
    {
        ...
        return redirect()->route('vendor-invoice.create')->withStatus("Party created successfully");
    }
